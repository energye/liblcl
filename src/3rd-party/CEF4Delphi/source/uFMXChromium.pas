...
function TFMXChromium.doRunModal(const browser: ICefBrowser): Boolean;
begin
  Result := False;
...
procedure TFMXChromium.doOnLoadStart(const browser: ICefBrowser; const frame: ICefFrame);
begin
